...
--
-- Name: properties fk_constraint_atomic_number; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_constraint_atomic_number FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
